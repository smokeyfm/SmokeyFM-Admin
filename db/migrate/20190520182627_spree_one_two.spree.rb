...
class SpreeOneTwo < ActiveRecord::Migration[4.2]
    def up
        ...
        add_index :spree_adjustments,
                  %i[adjustable_id],
                  name: 'index_adjustments_on_order_id'
        ...
        add_index :spree_assets,
                  %i[viewable_id],
                  name: 'index_assets_on_viewable_id'
        add_index :spree_assets,
                  %i[viewable_type type],
        ...
        add_index :spree_configurations,
                  %i[name type],
                  name: 'index_spree_configurations_on_name_and_type'
        ...
        add_index :spree_inventory_units,
                  %i[order_id],
                  name: 'index_inventory_units_on_order_id'
        add_index :spree_inventory_units,
                  %i[shipment_id],
                  name: 'index_inventory_units_on_shipment_id'
        add_index :spree_inventory_units,
                  %i[variant_id],
                  name: 'index_inventory_units_on_variant_id'
        ...
        add_index :spree_line_items,
                  %i[order_id],
                  name: 'index_spree_line_items_on_order_id'
        add_index :spree_line_items,
                  %i[variant_id],
                  name: 'index_spree_line_items_on_variant_id'
        ...
        add_index :spree_orders,
                  %i[number],
                  name: 'index_spree_orders_on_number'
        ...
        add_index :spree_preferences,
                  %i[key],
                  name: 'index_spree_preferences_on_key', unique: true
        ...
        add_index :spree_product_properties,
                  %i[product_id],
                  name: 'index_product_properties_on_product_id'
        ...
        add_index :spree_products,
                  %i[available_on],
                  name: 'index_spree_products_on_available_on'
        add_index :spree_products,
                  %i[deleted_at],
                  name: 'index_spree_products_on_deleted_at'
        add_index :spree_products,
                  %i[name],
                  name: 'index_spree_products_on_name'
        add_index :spree_products,
                  %i[permalink],
                  name: 'index_spree_products_on_permalink'
        ...
        add_index :spree_products_taxons,
                  %i[product_id],
                  name: 'index_spree_products_taxons_on_product_id'
        add_index :spree_products_taxons,
                  %i[taxon_id],
                  name: 'index_spree_products_taxons_on_taxon_id'
        ...
        add_index :spree_roles_users,
                  %i[role_id],
                  name: 'index_spree_roles_users_on_role_id'
        add_index :spree_roles_users,
                  %i[user_id],
                  name: 'index_spree_roles_users_on_user_id'
        ...
        add_index :spree_shipments,
                  %i[number],
                  name: 'index_shipments_on_number'
        ...
        add_index :spree_taxons,
                  %i[parent_id],
                  name: 'index_taxons_on_parent_id'
        add_index :spree_taxons,
                  %i[permalink],
                  name: 'index_taxons_on_permalink'
        add_index :spree_taxons,
                  %i[taxonomy_id],
                  name: 'index_taxons_on_taxonomy_id'
        ...
        add_index :spree_tokenized_permissions,
                  %i[permissable_id permissable_type],
