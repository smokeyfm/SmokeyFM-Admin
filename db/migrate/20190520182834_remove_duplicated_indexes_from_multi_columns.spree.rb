...
class RemoveDuplicatedIndexesFromMultiColumns < ActiveRecord::Migration[4.2]
    def change
        ...
        remove_index :spree_option_values_variants,
                     name:
        ...
        remove_index :spree_products_promotion_rules,
                     name: 'index_products_promotion_rules_on_promotion_rule_id'
        remove_index :spree_promotion_rules_users,
                     name: 'index_promotion_rules_users_on_user_id'
