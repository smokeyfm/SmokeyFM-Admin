...
class CreateSpreeReturnAuthorizationReasons < ActiveRecord::Migration[4.2]
    def change
        ...
        reversible do |direction|
            direction.up do
                Spree::ReturnAuthorizationReason.create!(
                    name: 'Better price available'
                )
                Spree::ReturnAuthorizationReason.create!(
                    name: 'Missed estimated delivery date'
                )
                Spree::ReturnAuthorizationReason.create!(
                ...
                Spree::ReturnAuthorizationReason.create!(
                    name: 'Different from description'
                )
                Spree::ReturnAuthorizationReason.create!(
        ...
        add_column :spree_return_authorizations,
                   :return_authorization_reason_id,
                   :integer
        add_index :spree_return_authorizations,
                  :return_authorization_reason_id,
                  name:
