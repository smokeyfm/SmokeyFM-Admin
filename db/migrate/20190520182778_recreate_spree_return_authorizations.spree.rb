...
class RecreateSpreeReturnAuthorizations < ActiveRecord::Migration[4.2]
    def up
        ...
        if Spree::ReturnAuthorization.exists?
            rename_table :spree_return_authorizations,
                         :spree_legacy_return_authorizations
            rename_column :spree_inventory_units,
        ...
        Spree::Adjustment.where(source_type: 'Spree::ReturnAuthorization')
            .update_all(source_type: 'Spree::LegacyReturnAuthorization')
    ...
    def down
        ...
        Spree::Adjustment.where(source_type: 'Spree::LegacyReturnAuthorization')
            .update_all(source_type: 'Spree::ReturnAuthorization')

        if data_source_exists?(:spree_legacy_return_authorizations)
            rename_table :spree_legacy_return_authorizations,
            ...
            add_column :spree_inventory_units,
                       :return_authorization_id,
                       :integer,
                       after: :shipment_id
